...
if(platform==='darwin' && process.platform==='darwin' && ['arm64','x64'].includes(arch)){
 ...
 execFileSync('clang++',['-arch',arch==='x64'?'x86_64':'arm64','-std=c++17','-shared','-undefined','dynamic_lookup',...includes,source,`-L${lib}`,'-lsteam_api','-Wl,-rpath,@loader_path','-o',target],{stdio:'inherit'})
