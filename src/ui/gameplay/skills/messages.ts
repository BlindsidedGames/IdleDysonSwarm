...
export const skillMessages = defineMessages({
  ...
  srsStellarMemoryEffect: { id: 'skills.srs.stellarMemory.effect', defaultMessage: 'Increase SRS charging speed by 10% × log10(total seconds spent with SRS assigned). Time accumulates across resets and includes Stored Time simulation, but excludes bonus charge. Bonuses are additive.' },
  ...
  srsHotStartEffect: { id: 'skills.srs.hotStart.effect', defaultMessage: 'Gain 30 minutes of SRS charge on first assignment each Infinity.' },
  ...
  srsAfterglowEffect: { id: 'skills.srs.afterglow.effect', defaultMessage: 'Retain 10% of SRS charge through Infinity, with no cap. Adds to Hot Start. Quantum Leap clears retained charge.' },
  ...
  srsDeepExposureEffect: { id: 'skills.srs.deepExposure.effect', defaultMessage: 'Increase SRS charging speed by 10% per minute this augment is assigned, up to 200% after 20 minutes. Resets on Infinity or Quantum Leap. Bonuses are additive.' },
  ...
  srsFocusedBeamEffect: { id: 'skills.srs.focusedBeam.effect', defaultMessage: 'Increase the SRS bonus above 1× by 50% for Cash or Science, whichever has more Bots assigned, and halve it for the other. Equal allocation leaves both unchanged.' },
  ...
  srsResearchConversionEffect: { id: 'skills.srs.researchConversion.effect', defaultMessage: 'Reduce Science production by 50%. Increase SRS charging speed by 100%. Bonuses are additive.' },
  ...
  srsResearchActivityEffect: { id: 'skills.srs.researchActivity.effect', defaultMessage: 'Gaining a research level increases SRS charging speed by 150% for 30 seconds. Generated levels count. Further gains refresh the duration. Bonuses are additive.' },
