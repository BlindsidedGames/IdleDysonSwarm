...
export const skillMessages = defineMessages({
  ...
  manualHandAssemblyEffect: { id: 'skills.manualLabour.handAssembly.effect', defaultMessage: 'Manual Labour produces 5% of your current Bots every 0.2 seconds, with a minimum of 1 Bot. Replaces Assembly Line tinkering; no AI Manager required.' },
  ...
  manualPracticeEffect: { id: 'skills.manualLabour.practice.effect', defaultMessage: 'Each completed Hand Assembly increases its Bot yield by 1% this Infinity. Refunding preserves practice. Bonuses are additive.' },
  ...
  manualWorkingSmarterEffect: { id: 'skills.manualLabour.workingSmarter.effect', defaultMessage: 'Increase Hand Assembly Bot yield by 10% per Assembly Line research level. After unlocking Discovery, use completed Discoveries instead. Bonuses are additive.' },
  ...
  manualPatientHandsEffect: { id: 'skills.manualLabour.patientHands.effect', defaultMessage: 'Increase Hand Assembly Bot yield by 100% per minute without activating it, up to +1,000% after 10 minutes. Consumed on activation. Bonuses are additive.' },
  ...
  srsAfterglowDescription: { id: 'skills.srs.afterglow.description', defaultMessage: "The last universe is gone, but some of its particles haven’t taken the hint." },
  srsAfterglowName: { id: 'skills.srs.afterglow.name', defaultMessage: 'Afterglow' },
  srsAfterglowEffect: { id: 'skills.srs.afterglow.effect', defaultMessage: 'Retain 10% of SRS charge through Infinity, multiplied by Stellar Memory up to 50% retention. Adds to Hot Start. Quantum Leap clears retained charge.' },
  srsDeepExposureDescription: { id: 'skills.srs.deepExposure.description', defaultMessage: "Your scientists recommend prolonged exposure. From behind a very thick window." },
  srsDeepExposureName: { id: 'skills.srs.deepExposure.name', defaultMessage: 'Deep Exposure' },
  srsDeepExposureEffect: { id: 'skills.srs.deepExposure.effect', defaultMessage: 'Increase SRS charging speed by 10% per minute this augment is assigned, up to 200% after 20 minutes. Stellar Memory multiplies these bonuses. Resets on Infinity or Quantum Leap. Bonuses are additive.' },
  srsFocusedBeamDescription: { id: 'skills.srs.focusedBeam.description', defaultMessage: "You ask the particles to form an orderly queue. Nobody expected that to work." },
  srsFocusedBeamName: { id: 'skills.srs.focusedBeam.name', defaultMessage: 'Focused Beam' },
  srsFocusedBeamEffect: { id: 'skills.srs.focusedBeam.effect', defaultMessage: 'Increase the SRS bonus above 1× by 50% for Cash or Science, whichever has more Bots assigned. Stellar Memory multiplies this increase. Halve the bonus for the other resource. Equal allocation leaves both unchanged.' },
  srsResearchConversionDescription: { id: 'skills.srs.researchConversion.description', defaultMessage: "You plug the research department into the reactor. Peer review is now a fire hazard." },
  srsResearchConversionName: { id: 'skills.srs.researchConversion.name', defaultMessage: 'Research Conversion' },
  srsResearchConversionEffect: { id: 'skills.srs.researchConversion.effect', defaultMessage: 'Reduce Science production by 50%. Increase SRS charging speed by 100%, multiplied by Stellar Memory. Bonuses are additive.' },
  srsResearchActivityDescription: { id: 'skills.srs.researchActivity.description', defaultMessage: "Every breakthrough gets a celebratory button press. Nobody remembers what the button was originally for." },
  srsResearchActivityName: { id: 'skills.srs.researchActivity.name', defaultMessage: 'Research Activity' },
  srsResearchActivityEffect: { id: 'skills.srs.researchActivity.effect', defaultMessage: 'Gaining a research level increases SRS charging speed by 150%, multiplied by Stellar Memory, for 30 seconds. Generated levels count. Further gains refresh the duration. Bonuses are additive.' },
  ...
  augmentsAssigned: { id: "skills.augments-assigned", defaultMessage: "Assigned augments: {complete}/{total}", description: "Owned optional augments out of the total available on a fractured skill." },
  ...
  galvPowerTaste: { id: "skills.galvPowerTaste", defaultMessage: "Assembly Lines, AI Managers, Servers, Data Centers and Planets are 50% stronger.", description: "Effective skill benefit after fracturing." },
  galvPowerIndulging: { id: "skills.galvPowerIndulging", defaultMessage: "Assembly Lines, AI Managers, Servers, Data Centers and Planets are 100% stronger.", description: "Effective skill benefit after fracturing." },
  galvPowerAddiction: { id: "skills.galvPowerAddiction", defaultMessage: "Assembly Lines, AI Managers, Servers, Data Centers and Planets are 200% stronger.", description: "Effective skill benefit after fracturing." },
  galvAlgorithms: { id: "skills.galvAlgorithms", defaultMessage: "Servers, AI Managers and Assembly Lines are 3× stronger.", description: "Effective skill benefit after fracturing." },
  galvBurnout: { id: "skills.galvBurnout", defaultMessage: "Triple panel production.", description: "Effective skill benefit after fracturing." },
  galvColdFusion: { id: "skills.galvColdFusion", defaultMessage: "10× Science production.", description: "Effective skill benefit after fracturing." },
  galvCables: { id: "skills.galvCables", defaultMessage: "5× as many Data Centers from Pocket Dimensions.", description: "Effective skill benefit after fracturing." },
  galvEconomic: { id: "skills.galvEconomic", defaultMessage: "20× Cash production.", description: "Effective skill benefit after fracturing." },
  galvEndLine: { id: "skills.galvEndLine", defaultMessage: "5× Bot production from Assembly Lines.", description: "Effective skill benefit after fracturing." },
  galvFusion: { id: "skills.galvFusion", defaultMessage: "5× Panel production.", description: "Effective skill benefit after fracturing." },
  galvScientific: { id: "skills.galvScientific", defaultMessage: "20× Science production.", description: "Effective skill benefit after fracturing." },
  galvPrecursors: { id: "skills.galvPrecursors", defaultMessage: "Science multipliers also multiply Cash production, alongside existing Cash multipliers.", description: "Effective skill benefit after fracturing." },
  galvStellarDominance: { id: "skills.galvStellarDominance", defaultMessage: "10× Panel Lifetime while the normal Bot requirement is met, without the extra sacrifice cost or Cash penalty.", description: "Effective skill benefit after fracturing." },
  ...
  galvanizedPermanent: { id: "skills.galvanized-permanent", defaultMessage: "Fractured \u00b7 permanently active", description: "Fractured skill details interface." },
  galvanizedHelp: { id: "skills.galvanized-help", defaultMessage: "This base skill is permanently active and costs no Skill Points. Its penalties and exclusions are removed. Normal conditions and timer resets still apply.", description: "Fractured skill details interface." },
  galvanizeAction: { id: "skills.galvanize-action", defaultMessage: "Fracture \u00b7 {currency}", description: "Fractured skill details interface." },
  galvanizeWarning: { id: "skills.galvanize-warning", defaultMessage: "Permanently fracture {name} for 1 Catalyst? Any Skill Points invested in this base skill are returned. This cannot be undone.", description: "Fractured skill details interface." },
  confirmGalvanize: { id: "skills.confirm-galvanize", defaultMessage: "Spend 1 Catalyst", description: "Fractured skill details interface." },
  subskills: { id: "skills.subskills", defaultMessage: "Augments", description: "Fractured skill details interface." },
  subskillsHelp: { id: "skills.subskills-help", defaultMessage: "Each costs 1 Skill Point; you can take all three. Checkboxes add them to the preset. Augments reset and refund normally.", description: "Fractured skill details interface." },
  ...
  subskillLifetime: { id: "skills.subskill-lifetime", defaultMessage: "+5 seconds Panel Lifetime", description: "Fractured skill details interface." },
  ...
  subskillDecay: { id: "skills.subskill-decay", defaultMessage: "Each decayed panel counts as 10", description: "Fractured skill details interface." },
  subskillProduction: { id: "skills.subskill-production", defaultMessage: "2\u00d7 Cash and Science production", description: "Fractured skill details interface." },
  subskillAssign: { id: "skills.subskill-assign", defaultMessage: "Assign {name} for 1 Skill Point", description: "Fractured skill details interface." },
  subskillRefund: { id: "skills.subskill-refund", defaultMessage: "Refund {name} for 1 Skill Point", description: "Fractured skill details interface." },
  subskillAssignShort: { id: "skills.subskill-assign-short", defaultMessage: "Assign", description: "Fractured skill details interface." },
  subskillRefundShort: { id: "skills.subskill-refund-short", defaultMessage: "Refund", description: "Fractured skill details interface." },
  spendingPriority: {
  ...
  showProductionComparisons: { id: 'skills.show-production-comparisons', defaultMessage: 'Show production comparisons' },
  productionCash: { id: 'skills.production-cash', defaultMessage: 'Cash' },
  productionScience: { id: 'skills.production-science', defaultMessage: 'Science' },
  productionPanels: { id: 'skills.production-panels', defaultMessage: 'Panels' },
  impactCashScience: {
