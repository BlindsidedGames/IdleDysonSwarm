...
export const statisticsMessages = defineMessages({
  ...
  speedrunEligible: { id: 'statistics.speedruns.speedrunEligible', defaultMessage: "Eligible", description: 'Speedrun statistics label or explanation.' },
  speedrunIneligible: { id: 'statistics.speedruns.speedrunIneligible', defaultMessage: "Ineligible — Debug used", description: 'Speedrun statistics label or explanation.' },
  speedrunUnverified: { id: 'statistics.speedruns.speedrunUnverified', defaultMessage: "Unverified", description: 'Speedrun statistics label or explanation.' },
  speedrunYes: { id: 'statistics.speedruns.speedrunYes', defaultMessage: "Yes", description: 'Speedrun statistics label or explanation.' },
  speedrunNo: { id: 'statistics.speedruns.speedrunNo', defaultMessage: "No", description: 'Speedrun statistics label or explanation.' },
