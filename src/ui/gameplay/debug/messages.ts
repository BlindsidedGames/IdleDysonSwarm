...
export const debugSurfaceMessages = defineMessages({
  ...
  amountHelp: { id: 'debug.amount-help', defaultMessage: 'Standard suffixes are accepted, including forms such as 100 Qi, 100xqi and 100 x qi.', description: 'Help for entering game-formatted numbers in Developer Options.' },
  invalidAmount: { id: 'debug.amount-invalid', defaultMessage: 'Enter a non-negative number using digits, scientific notation or a Standard game suffix.', description: 'Validation error for malformed developer resource input.' },
  continuousMaximum: { id: 'debug.amount-continuous-maximum', defaultMessage: 'Continuous resources cannot exceed {maximum}.', description: 'Validation error for developer values above the continuous resource cap.' },
