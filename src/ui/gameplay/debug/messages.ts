...
export const debugSurfaceMessages = defineMessages({
  ...
  amountHelp: { id: 'debug.amount-help', defaultMessage: 'Use Standard suffixes or exponents (100 Qi, 100xqi, e14 = 1e14). Negative amounts remove resources down to zero.', description: 'Help for entering signed game-formatted resource adjustments in Developer Options.' },
  invalidAmount: { id: 'debug.amount-invalid', defaultMessage: 'Enter an amount using digits, scientific notation or a Standard game suffix.', description: 'Validation error for malformed developer resource input.' },
  continuousMaximum: { id: 'debug.amount-continuous-maximum', defaultMessage: 'The absolute amount for continuous resources cannot exceed {maximum}.', description: 'Validation error for signed developer values whose magnitude exceeds the continuous resource cap.' },
  discreteMaximum: { id: 'debug.amount-discrete-maximum', defaultMessage: 'Whole-number resources cannot exceed {maximum}. Continuous resources may still accept this amount.', description: 'Validation guidance when developer input exceeds the whole-number resource cap.' },
  discreteWholeNumber: { id: 'debug.amount-discrete-whole', defaultMessage: 'Whole-number resources require an integer. Continuous resources may still accept this amount.', description: 'Validation guidance when developer input is fractional.' },
  setDoubleCap: { id: 'debug.set-double-cap', defaultMessage: 'Double cap', description: 'Button that fills the developer amount field with the maximum finite double value.' },
  setWholeCap: { id: 'debug.set-whole-cap', defaultMessage: 'Whole cap', description: 'Button that fills the developer amount field with the maximum supported whole-number value.' },
