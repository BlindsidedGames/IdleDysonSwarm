/**
 * Purpose:
 * - Defines the transport-only Unity asset fields required by the browser
 *   canonical runtime.
 *
 * Runs:
 * - Imported by the Unity data exporter and runtime-catalog contract tests.
 ...
 *   state transition to the authored Unity assets and canonical runtime.
 *
 * Change notes:
 * - Adding a canonical consumer field requires adding that field here and
 *   regenerating `generated/runtime-catalog.json`.
