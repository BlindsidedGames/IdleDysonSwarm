...
export const deferredNumericCoverage = Object.freeze([
  {
    boundary: 'V2 transaction quote and commit DTOs',
    reason: 'Immutable Decimal quote/commit types are introduced after Stage 0.',
    activationGate:
      'Each quote numeric leaf must be classified and no cost or quantity may narrow through number.',
  },
  {
    boundary: 'V2 frontend resource projections',
    reason: 'The current projection is typed against CanonicalGameStateV1.',
    activationGate:
      'Stage 7 must mechanically walk the V2 projection and manifest every bounded presentation conversion.',
  },
