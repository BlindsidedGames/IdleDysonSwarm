...
namespace Rotorz.ReorderableList
{
    ...
    public class ReorderableListControl
    {
        ...
        /// </summary>
        static GUIStyle s_RightAlignedLabelStyle;
        ...
        static readonly int s_ReorderableListControlHint = "_ReorderableListControl_".GetHashCode();

        static int GetReorderableListControlID()
        {
        ...
        /// </summary>
        static float s_AnchorMouseOffset;
        /// <summary>
        ...
        /// </summary>
        static int s_AutoFocusControlID = 0;
        /// <summary>
        /// Zero-based index of item which should be focused.
        /// </summary>
        static int s_AutoFocusIndex = -1;
        ...
        /// </summary>
        static readonly Stack<ListInfo> s_CurrentListStack;

        /// <summary>
        /// Represents the current stack of nested reorderable list items.
        /// </summary>
        static readonly Stack<ItemInfo> s_CurrentItemStack;
        ...
        /// </summary>
        bool HasFooterControls => HasSizeField || HasAddButton || HasAddMenuButton;

        /// <summary>
        /// Gets a value indicating whether the size field is shown.
        /// </summary>
        bool HasSizeField => (_flags & ReorderableListFlags.ShowSizeField) != 0;

        /// <summary>
        /// Gets a value indicating whether add button is shown.
        /// </summary>
        bool HasAddButton => (_flags & ReorderableListFlags.HideAddButton) == 0;
        /// <summary>
        /// Gets a value indicating whether add menu button is shown.
        /// </summary>
        bool HasAddMenuButton { get; set; }

        /// <summary>
        /// Gets a value indicating whether remove buttons are shown.
        /// </summary>
        bool HasRemoveButtons => (_flags & ReorderableListFlags.HideRemoveButtons) == 0;

        float _verticalSpacing = 10f;
        GUIStyle _containerStyle;
        GUIStyle _footerButtonStyle;
        GUIStyle _itemButtonStyle;
        ...
        bool _horizontalLineAtStart = false;
        bool _horizontalLineAtEnd = false;
        ...
        event AddMenuClickedEventHandler _addMenuClicked;
        int _addMenuClickedSubscriberCount = 0;
        ...
        /// <param name="adaptor">Reorderable list adaptor.</param>
        void PrepareState(int controlID, IReorderableListAdaptor adaptor)
        {
        ...
        static int s_SimulateMouseDragControlID;
        ...
        void AutoFocusItem(int controlID, int itemIndex)
        {
        ...
        /// </returns>
        bool DoRemoveButton(Rect position, bool visible)
        {
        ...
        static bool s_TrackingCancelBlockContext;
        ...
        static void BeginTrackingReorderDrag(int controlID, int itemIndex)
        {
        ...
        /// </summary>
        static void StopTrackingReorderDrag()
        {
        ...
        /// </returns>
        static bool IsTrackingControl(int controlID)
        {
        ...
        /// </summary>
        /// <param name="adaptor">Reorderable list adaptor.</param>
        void AcceptReorderDrag(IReorderableListAdaptor adaptor)
        {
            try
            {
        ...
        static Rect s_DragItemPosition;

        // Micro-optimisation to avoid repeated construction.
        static Rect s_RemoveButtonPosition;

        void DrawListItem(Rect position, IReorderableListAdaptor adaptor, int itemIndex)
        {
        ...
        void DrawFloatingListItem(IReorderableListAdaptor adaptor, float targetSlotPosition)
        {
        ...
        static int s_DropTargetNestedCounter = 0;
        ...
        /// <param name="adaptor">Reorderable list adaptor.</param>
        void DrawListContainerAndItems(Rect position, IReorderableListAdaptor adaptor)
        {
...
//*/
        ...
        void HandleDropInsertion(Rect position, IReorderableListAdaptor adaptor)
        {
        ...
        /// <param name="position">Position of list control in GUI.</param>
        /// <param name="adaptor">Reorderable list adaptor.</param>
        void DrawFooterControls(Rect position, IReorderableListAdaptor adaptor)
        {
            if (HasFooterControls)
            {
                ...
                if (HasAddMenuButton) // Draw add menu drop-down button.
        ...
        void DrawSizeFooterControl(Rect position, IReorderableListAdaptor adaptor)
        {
        ...
        /// </summary>
        static readonly Dictionary<int, float> s_ContainerHeightCache = new Dictionary<int, float>();

        Rect GetListRectWithAutoLayout(IReorderableListAdaptor adaptor, float padding)
        {
            float totalHeight;
        ...
        /// </returns>
        Rect DrawLayoutListField(IReorderableListAdaptor adaptor, float padding)
        {
        ...
        /// Position of list container area in GUI (excludes footer area).
        /// </returns>
        Rect DrawLayoutEmptyList(IReorderableListAdaptor adaptor, DrawEmpty drawEmpty)
        {
        ...
        /// <param name="position">Position of list control in GUI.</param>
        /// <param name="drawEmpty">Callback to draw empty content.</param>
        void DrawEmptyListControl(Rect position, DrawEmptyAbsolute drawEmpty)
        {
            if (Event.current.type == EventType.Repaint)
                ContainerStyle.Draw(position, GUIContent.none, false, false, false, false);
        ...
        /// <param name="adaptor">Reorderable list adaptor.</param>
        /// <param name="drawEmpty">Delegate for drawing empty list.</param>
        void Draw(int controlID, IReorderableListAdaptor adaptor, DrawEmpty drawEmpty)
        {
            FixStyles();
        ...
        /// <param name="adaptor">Reorderable list adaptor.</param>
        /// <param name="drawEmpty">Delegate for drawing empty list.</param>
        void Draw(Rect position, int controlID, IReorderableListAdaptor adaptor, DrawEmptyAbsolute drawEmpty)
        {
            FixStyles();
            PrepareState(controlID, adaptor);
        ...
        static readonly GUIContent s_Temp = new GUIContent();
        static readonly GUIContent s_SizePrefixLabel = new GUIContent("Size");
        ...
        static int s_ContextControlID;
        static int s_ContextItemIndex;

        // Command name is assigned by default context menu handler.
        static string s_ContextCommandName;

        void ShowContextMenu(int itemIndex, IReorderableListAdaptor adaptor)
        {
        ...
        static void DefaultContextMenuHandler(object userData)
        {
        ...
        {
            if (newCount < 0) // Do nothing when new count is negative.
                return true;
