...
namespace Rotorz.ReorderableList.Internal
{
    ...
    public static class GUIHelper
    {
        ...
        static readonly GUIStyle s_TempStyle = new GUIStyle();
        ...
        static readonly GUIContent s_TempIconContent = new GUIContent();
        static readonly int s_IconButtonHint = "_ReorderableIconButton_".GetHashCode();
        ...
        static readonly Color s_SeparatorColor;
        static readonly GUIStyle s_SeparatorStyle;
