...
namespace Blindsided.ProceduralUIImage {
    [AddComponentMenu("UI/Blindsided/Procedural UIImage Basic")]
    public class ProceduralUIImageBasic : Image {
...
#pragma warning restore
            ...
            get
            {
                switch (m_DrawShape)
                {
                    ...
                    case DrawShape.Parallelogram:
                        return ProceduralUIImageMaterials.GetMaterial((int)m_DrawShape - 1, m_StrokeWidth > 0f, m_OutlineWidth > 0f);
                    case DrawShape.Pentagon:
                    case DrawShape.Hexagon:
                    case DrawShape.NStarPolygon:
                        return ProceduralUIImageMaterials.GetMaterial(3, m_StrokeWidth > 0f, m_OutlineWidth > 0f);
                    default:
        ...
        public override float preferredWidth => sprite == ProceduralUIImageUtility.EmptySprite ? 0 : base.preferredWidth;
        public override float preferredHeight => sprite == ProceduralUIImageUtility.EmptySprite ? 0 : base.preferredHeight;


        protected override void OnEnable() {
            base.OnEnable();
            ProceduralUIImageUtility.FixAdditionalShaderChannelsInCanvas(canvas);
            if (sprite == null) sprite = ProceduralUIImageUtility.EmptySprite;
        }
        ...
        private ProceduralUIImageVertexStream CreateVertexStream() {
            ProceduralUIImageVertexStream stream = new ProceduralUIImageVertexStream();
            ...
            switch (m_DrawShape) {
                ...
                case DrawShape.Triangle:
                    ...
                    shapeProps = ProceduralUIImageUtility.Encode_0_1_16(data);
                    break;
                case DrawShape.Rectangle:
        ...
        protected override void OnPopulateMesh(VertexHelper toFill) {
            ...
            ProceduralUIImageVertexStream stream = CreateVertexStream();
