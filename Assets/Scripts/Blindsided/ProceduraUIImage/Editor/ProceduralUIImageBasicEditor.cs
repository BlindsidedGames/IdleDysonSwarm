...
namespace Blindsided.ProceduralUIImage.Editor {
    [CustomEditor(typeof(ProceduralUIImageBasic))]
    public class ProceduralUIImageBasicEditor : ImageEditor {
        ...
        private void CircleGUI() {
            ...
            ProceduralUIImageEditorUtility.CornerRadiusModeGUI(rect, ref spCircleFitToRect, new[] {"Free", "Fit"}, String.Empty);
        }
        ...
        private void RectangleGUI() {
            ...
            ProceduralUIImageEditorUtility.CornerRadiusModeGUI(rect, ref spRectangleUniformCornerRadius, new[] {"Free", "Uniform"});
        ...
        private void TriangleGUI() {
            Rect rect = EditorGUILayout.GetControlRect(true, EditorGUIUtility.singleLineHeight);
            ProceduralUIImageEditorUtility.CornerRadiusModeGUI(rect, ref spTriangleUniformCornerRadius, new[] {"Free", "Uniform"});
        ...
        private void RotationGUI() {
            ...
            EditorGUI.BeginDisabledGroup(spConstrainRotation.boolValue);
            {
                ...
                EditorGUI.BeginChangeCheck();
                {
                    ...
                    rotationValue =
                        ProceduralUIImageEditorGUILayoutExtended.FloatFieldExtended(line, spShapeRotation.floatValue, dragZone);
                    EditorGUI.showMixedValue = false;
                }
                if (EditorGUI.EndChangeCheck()) {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                flipH = GUI.Toggle(line, spFlipHorizontal.boolValue,
                    spFlipHorizontal.boolValue
                        ? ProceduralUIImageEditorContents.FlipHorizontalActive
                        : ProceduralUIImageEditorContents.FlipHorizontalNormal, "button");
                line.x += 34;
                flipV = GUI.Toggle(line, spFlipVertical.boolValue,
                    spFlipVertical.boolValue
                        ? ProceduralUIImageEditorContents.FlipVerticalActive
                        : ProceduralUIImageEditorContents.FlipVerticalNormal, "button");
                EditorGUI.EndDisabledGroup();
            }
            if (EditorGUI.EndChangeCheck()) {
        ...
        private new void SpriteGUI() {
            ...
            Sprite sprite = ProceduralUIImageEditorUtility.EmptySprite.Equals(spriteRef) ? null : spriteRef;
            ...
            if (EditorGUI.EndChangeCheck()) {
                Sprite newSprite = sprite == null? ProceduralUIImageEditorUtility.EmptySprite : sprite;
                if (newSprite != null) {
