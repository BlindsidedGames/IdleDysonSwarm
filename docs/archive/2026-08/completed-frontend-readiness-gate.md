...
> Historical gate, now completed and superseded by the canonical React product
> frontend and the living product/UI contracts. The prohibitions below record
> the pre-frontend state and are not current instructions.
