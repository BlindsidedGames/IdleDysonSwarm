...
and then uses the effective release identity compiled into that package,
including a validated native release-candidate override. A late bridge response
is ignored and cannot re-block startup or replace the already selected footer
identity.
